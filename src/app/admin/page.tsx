      ...
      <main className="flex-1 flex flex-col min-w-0 gradient-warm overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto px-4 sm:px-8 py-8">
          <div className="max-w-5xl mx-auto animate-fade-in">
            ...
            <Link
              href="/admin/insights"
              className="block mb-8 p-5 rounded-2xl card-luxury group"
            >
              <div className="flex items-center gap-4">
                <div
                  className="w-12 h-12 rounded-xl flex items-center justify-center shrink-0 btn-gradient"
                  style={{ color: "#fff" }}
                >
                ...
                <div className="flex-1">
                  <p className="text-[14px] font-semibold mb-0.5 group-hover:text-[var(--accent-light)] transition-colors" style={{ color: "var(--foreground)" }}>
                    Insights da plataforma
                  </p>
                  <p className="text-[12px]" style={{ color: "var(--text-muted)" }}>
                    Faça perguntas sobre o comportamento dos usuários e a IA analisa todas as conversas pra você.
                  </p>
                </div>
