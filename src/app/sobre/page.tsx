        ...
        <div className="flex-1 overflow-y-auto px-4 sm:px-8 py-8">
          <div className="max-w-2xl mx-auto animate-fade-in">
            ...
            <div className="mb-8">
              ...
              <div className="p-6 rounded-2xl card-luxury space-y-4">
            ...
            <div className="mb-10">
              ...
              <div className="space-y-3">
                {[
                  { perfil: "Estrategistas", desc: "Que precisam de clareza para escalar criativos com segurança." },
                  { perfil: "Copywriters", desc: "Que querem isolar blocos de persuasão vencedores e replicar o que funciona." },
                  { perfil: "Experts", desc: "Que precisam entender o que gravar para acertar como sniper." },
                ].map((item) => (
                  <div key={item.perfil} className="p-5 rounded-2xl card-luxury">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="text-[13px] font-semibold mb-0.5" style={{ color: "var(--foreground)" }}>{item.perfil}</p>
